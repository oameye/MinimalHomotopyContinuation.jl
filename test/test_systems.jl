...
function minors()
    ...
    exprs = [
        ...
        (2 / 3) * x^6 + (220411 / 37800) * x^5 * y - (494933 / 113400) * x^4 * y^2 +
            ...
            (25273 / 132300) * z^4 + (193469 / 10800) * x^3 - (12734041 / 2268000) * x^2 * y +
            (264791 / 64800) * x * y^2 +
            (525217 / 86400) * y^3 +
            (279821 / 31500) * x^2 * z +
        ...
        -(489 / 40) * x^6 - (77719 / 15120) * x^5 * y +
            ...
            (20820743 / 1270080) * x * z^3 - (14009717 / 2116800) * y * z^3 -
            (1723 / 1512) * z^4 +
            (93439 / 32400) * x^3 +
        ...
        -(561 / 140) * x^6 + (460223 / 58800) * x^5 * y - (7650443 / 352800) * x^4 * y^2 -
            (1992937 / 98000) * x^3 * y^3 - (39587 / 7875) * x^2 * y^4 -
            (28771 / 11340) * x * y^5 + (301 / 675) * y^6 - (37523 / 3360) * x^5 * z -
            (38302421 / 4233600) * x^4 * y * z + (55466501 / 705600) * x^3 * y^2 * z -
            (23967241 / 3175200) * x^2 * y^3 * z +
        ...
        -(101 / 20) * x^6 - (126451 / 12600) * x^5 * y - (52649 / 2100) * x^4 * y^2 +
            ...
            (3832951 / 453600) * x^2 * y^2 - (17641 / 189000) * x * y^3 -
            (18203 / 14400) * y^4 - (2501867 / 45360) * x^3 * z -
            ...
            (34141027 / 846720) * x * z^3 - (31854803 / 1411200) * y * z^3 -
            (3474301 / 705600) * z^4 - (4121 / 2160) * x^3 + (2152697 / 129600) * x^2 * y -
...
function six_revolute()
    ...
    h =
        sum(a[i] .* (z[i, :] × z[i + 1, :]) for i in 1:3) + sum(a[i + 4] .* z[i, :] for i in 2:5)
    F′ = [f .- 1; g .- cos.(α); h .- p]
    ## assign values to z₁ and z₆
    return System([subs(f, z[1, :] => [1, 0, 0], z[6, :] => [1, 0, 0]) for f in F′])
end
